...
public class CommonUtils {
	...
	public static String APPLICATION_NAME; //Needed in case app is not installed or comment it
	...
	public static void loadAndroidConfigProp(String propertyFileName) throws IOException
	 {
		...
		IMPLICIT_WAIT_TIME = Integer
				.parseInt(prop.getProperty("implicit.wait"));
		APPLICATION_NAME = prop.getProperty("application.path"); //Needed in case app is not installed or comment it
...
//				PLATFORM_VERSION);
		...
		capabilities.setCapability(MobileCapabilityType.APP, CommonUtils.APPLICATION_NAME); //Needed in case app is not installed or comment it
